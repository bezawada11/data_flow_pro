  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        running: 'border-transparent bg-orange-100 text-orange-800',
        ...
        connected: 'border-transparent bg-green-100 text-green-800',
        available: 'border-transparent bg-gray-100 text-gray-800',
      },
    },
    defaultVariants: {
      variant: 'default',
